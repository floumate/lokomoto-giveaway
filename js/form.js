...
const Form = (function() {
  ...
  // ============================================
  const REFERRAL_API = 'https://lokomoto-referral-system.vercel.app/api/signup'; // pravi Supabase backend
  ...
  function renderMri(step, index) {
    ...
    setScreen(`
      ...
      <div class="upload-block">
        ...
        <button type="button" class="upload-btn" id="mriBtn">
          ...
          <span id="mriBtnLabel">Priloži</span>
        </button>
    ...
    function setUploadLabel(hasFile) { mriBtnLabel.textContent = hasFile ? 'Izmeni' : 'Priloži'; }
